...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "MenuCraft",
    description:
      "Design and generate professional restaurant, café, hotel, and bakery menus without hiring a designer.",
    tech: ["FastAPI", "Jinja2", "Tailwind CSS", "ReportLab"],
    github: "https://github.com/MaryamMumtaz-piaic/menucraft",
    live: "",
    image: "/menu-card.PNG",
    featured: true,
    category: "AI Automation",
    highlights: [
      "Design professional menus for restaurants, cafés, hotels, and bakeries in minutes",
      "No design skills required — guided menu-building workflow",
      "Built on FastAPI with server-rendered Jinja2 templates and Tailwind CSS styling",
      "PDF menu export powered by ReportLab",
    ],
  },
  {
    slug: "ultron-knowledge-rag",
    title: "Ultron Knowledge RAG",
    description:
      "A compact, professional Retrieval-Augmented Generation knowledge chatbot that answers strictly from a source's content, with references back to the exact chunks used.",
    tech: ["Python", "RAG", "FastAPI", "OpenAI SDK", "Vector Database"],
    github: "https://github.com/MaryamMumtaz-piaic/ultron-knowledge-rag",
    live: "",
    image: "/ultron-rag.png",
    featured: true,
    category: "RAG",
    highlights: [
      "Add a website URL or upload a document as the knowledge source",
      "Answers are grounded strictly in the provided source content",
      "Cites references back to the exact chunks used for each answer",
      "Compact, professional chatbot interface built for focused Q&A",
    ],
  },
  {
    slug: "foodflow",
    title: "FoodFlow",
    description:
      "A complete food-delivery web application connecting customers, restaurants, delivery riders, and administrators in one modern, responsive platform, enhanced with specialized AI agents.",
    tech: ["Next.js", "TypeScript", "Node.js", "OpenAI SDK", "Multi-Agent AI"],
    github: "https://github.com/MaryamMumtaz-piaic/foodflow",
    live: "",
    image: "/foodflow.png",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "Unified platform for customers, restaurants, delivery riders, and administrators",
      "AI agents for natural-language food search and personalized recommendations",
      "Menu intelligence and delivery time estimation agents",
      "AI-powered customer support, business insights, and fraud detection",
    ],
  },
  {
    slug: "ai-home-intelligence-hub",
    title: "AI Home Intelligence Hub",
    description:
      "A premium, full-stack home-management platform. Build a digital model of your home and a team of specialized AI agents turns it into an explainable, room-by-room intelligence report.",
    tech: ["Next.js", "TypeScript", "Python", "OpenAI SDK", "Multi-Agent AI"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-home-intelligence-hub",
    live: "",
    image: "/ai-home-intelligence-hub.png",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "Digital home model spanning rooms, furniture, appliances, lifestyle, energy, and safety",
      "Specialized AI agents generate a room-by-room intelligence report",
      "Explainable recommendations and a practical task roadmap",
      "Interactive what-if scenarios for planning changes",
    ],
  },
  {
    slug: "ai-wedding-designer",
    title: "AI Wedding Designer",
    description:
      "A complete AI-powered wedding planning and invitation design platform, where specialized AI agents build a full wedding plan that flows into a live, editable, printable invitation.",
    tech: ["Next.js", "TypeScript", "OpenAI SDK", "HTML/CSS/SVG", "Multi-Agent AI"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-wedding-designer",
    live: "",
    image: "/ai-wedding.png",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "AI agents build a full wedding plan from style, culture, location, guests, and budget",
      "Covers budget, venue guidance, décor direction, catering, vendors, timeline, and checklist",
      "Wedding plan flows directly into a live, editable, printable invitation",
      "Invitations designed entirely in HTML/CSS/SVG — no AI image generation used",
    ],
  },
  {
    slug: "ai-restaurant-intelligence-platform",
    title: "AI Restaurant Intelligence Platform",
    description:
      "A premium, AI-powered dining intelligence platform that answers one question: where should I eat, and why is this the best option for me?",
    tech: ["Next.js", "TypeScript", "Python", "OpenAI SDK", "Multi-Agent AI"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-restaurant-intelligence-platform",
    live: "",
    image: "/ai-resturent.PNG",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "AI-driven dining recommendations personalized to the diner",
      "Explains why a restaurant is the best option for a given diner",
      "Premium intelligence-report style presentation of results",
    ],
  },
  {
    slug: "ai-home-renovation-planner",
    title: "AI Home Renovation Planner",
    description:
      "A premium, AI-powered renovation planning platform. Describe a room, goals, budget, and style, and a pipeline of specialized AI agents turns that into a complete renovation plan.",
    tech: ["Next.js", "TypeScript", "Python", "OpenAI SDK", "Multi-Agent AI"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-home-renovation-planner",
    live: "",
    image: "/ai-home-renovation.png",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "Full renovation plan from a described room, goals, budget, and style",
      "Design concept, space plan, and detailed budget breakdown",
      "Material recommendations and a shopping list",
      "Timeline and execution checklist generated by the agent pipeline",
    ],
  },
  {
    slug: "ai-seo-strategist-platform",
    title: "AI SEO Strategist",
    description:
      "A complete, production-style AI SEO intelligence platform. Enter a website URL and a pipeline of specialized AI agents produces a full SEO report and downloadable implementation files.",
    tech: ["Next.js", "TypeScript", "Python", "OpenAI SDK", "Multi-Agent AI"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-seo-strategist-platform",
    live: "",
    image: "/ai-seo.png",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "Crawls a site and runs results through a pipeline of specialized AI agents",
      "Full SEO report: score, technical audit, keyword opportunities, content gaps",
      "Competitor insights, internal-linking map, and a 90-day content roadmap",
      "Downloadable SEO files: sitemap, robots.txt, llms.txt, schema, meta recommendations",
    ],
  },
  {
    slug: "ai-travel-planner-platform",
    title: "AI Travel Planner",
    description:
      "A complete, end-to-end AI travel planning platform that matches real local hotels and activities, then uses GPT-4.1-mini to build a full day-by-day itinerary.",
    tech: ["Next.js", "TypeScript", "OpenAI GPT-4.1-mini", "PDF Export"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-travel-planner-platform",
    live: "",
    image: "/ai-travel-planner.png",
    featured: true,
    category: "Agentic AI",
    highlights: [
      "Matches real local hotels and activities to the destination and budget",
      "GPT-4.1-mini builds a full day-by-day editable itinerary",
      "Save, print, and download the itinerary as a PDF",
      "Shareable trip plans end-to-end",
    ],
  },
  {
    slug: "ai-recipe-agent",
    title: "AI Recipe Agent",
    description:
      "A complete, production-quality AI-powered recipe discovery and personalization platform with a curated library of 30 recipes spanning 16 world cuisines and a guided AI Recipe Builder.",
    tech: ["Next.js", "TypeScript", "OpenAI SDK"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-recipe-agent",
    live: "",
    image: "/ai-recipe-platform.png",
    featured: true,
    category: "AI Automation",
    highlights: [
      "Curated library of 30 recipes spanning 16 world cuisines",
      "Guided AI Recipe Builder tailored to region, cuisine, and servings",
      "Accounts for budget, dietary needs, and ingredients on hand",
      "Personalizes by cooking method, time available, and difficulty",
    ],
  },
  {
    slug: "ai-job-hunter",
    title: "AI Job Hunter",
    description:
      "A local MVP web application that uses OpenAI to discover, analyze, and apply for jobs intelligently, with match scores, skill gap analysis, and a human-in-the-loop approval workflow.",
    tech: ["Python", "OpenAI SDK", "FastAPI"],
    github: "https://github.com/MaryamMumtaz-piaic/ai-job-hunter",
    live: "",
    image: "/ai-job-hunter.png",
    featured: true,
    category: "AI Automation",
    highlights: [
      "Upload a resume and set job preferences to match curated opportunities",
      "Match scores and skill gap analysis for each job",
      "Personalized cover letter generation",
      "Human-in-the-loop approval workflow before any application is recorded",
    ],
  },
];
...
export const achievements = [
  ...
  { label: "Portfolio Projects", value: "35" },
